...
const COMMAND_KEYS: { name: string; key: string }[] = [
  ...
  // Direct-CLI management commands, reachable in the shell as slash commands
  // (m-shell↔CLI parity) — each runs the SAME command as `excalibur <name>`.
  { name: 'work-items', key: 'cmd.work-items' },
  { name: 'sprints', key: 'cmd.sprints' },
  { name: 'plans', key: 'cmd.plans' },
  { name: 'verify', key: 'cmd.verify' },
  { name: 'review', key: 'cmd.review' },
  { name: 'mission', key: 'cmd.mission' },
  { name: 'orchestrate', key: 'cmd.orchestrate' },
  { name: 'schedule', key: 'cmd.schedule' },
  { name: 'scope', key: 'cmd.scope' },
  { name: 'status', key: 'cmd.status' },
  { name: 'stats', key: 'cmd.stats' },
  { name: 'logs', key: 'cmd.logs' },
  { name: 'insights', key: 'cmd.insights' },
  { name: 'agents', key: 'cmd.agents' },
  { name: 'skills', key: 'cmd.skills' },
  { name: 'session', key: 'cmd.session' },
