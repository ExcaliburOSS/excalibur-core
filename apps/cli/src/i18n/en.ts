...
export const EN: Catalog = {
  ...
  'plans.diff_need_two': 'Need at least two saved plans to diff.',
  'plans.diff_missing': "Couldn't read one of those plans.",
  'plans.diff_heading': 'Plan diff · {from} → {to}',
  'plans.diff_phases': 'Phases: {changes}',
  'sprints.none': 'No sprints yet. Create one with `excalibur sprints create`.',
  'sprints.status.planned': 'Planned',
  'sprints.status.active': 'Active',
  'sprints.status.completed': 'Completed',
  'sprints.col_id': 'Sprint',
  'sprints.col_name': 'Name',
  'sprints.col_status': 'Status',
  'sprints.col_window': 'Window',
  'sprints.col_items': 'Items',
  'sprints.col_points': 'Points',
  'sprints.needs_name': 'A sprint needs a name.',
  'sprints.bad_date': '{label} must be a YYYY-MM-DD date (got "{value}").',
  'sprints.not_found': 'No sprint "{id}".',
  'sprints.created': 'Created {id} · {name}.',
  'sprints.started': 'Sprint {id} is now active.',
  'sprints.completed': 'Sprint {id} completed.',
  'sprints.assigned': 'Assigned {count} work-item(s) to {id}.',
  'sprints.assign_failed': "Couldn't assign {key}.",
  'sprints.points_summary': '{done}/{total} points done · {items} items',
  'sprints.burndown': 'Burndown (remaining points):',
  'sprints.remaining': '{n} remaining',
  'sprints.no_items': 'No work-items in this sprint yet. Assign some with `sprints assign`.',
  ...
  'swarm.wave': 'wave {n}',
  'swarm.verifying': 'Verifying the merged result against the configured tests…',
  'swarm.verified': 'Verified fan-in: {detail}.',
  'swarm.verifyFailed':
  ...
  'swarm.lane-cancelled': 'Lane cancelled: {title} (skipped — no model spend).',
  'swarm.retryFailed': '{n} lane(s) failed — retry just those now?',
  ...
  'run-pipeline.estimateFromRuns': '(from {count} past task(s))',
  ...
  'run-pipeline.runCancelled': 'Task cancelled.',
  ...
  'run-pipeline.runDir': 'Task {id} → {dir}',
  'run-pipeline.runCompleted': 'Task {id} completed.',
  'run-pipeline.runFinishedStatus': 'Task {id} finished with status: {status}',
  ...
  'turn-receipt.hint-review': 'already applied to your project — review with  /changes',
  ...
  'repl.route-explore-offer':
    'This looks worth exploring — run a few candidate approaches in parallel and pick the best (best-of-N)?',
  ...
  'repl.schedule-duplicate': 'That is already scheduled ({spec}) — not adding a duplicate.',
  'repl.schedule-cap':
    'You already have {max} scheduled jobs — remove some with `schedule remove` first.',
  ...
  'repl.passthrough-daemon':
    '`{cmd}` is a long-lived daemon — run it in its own terminal so it does not freeze the shell.',
  'cmd.auto': 'Toggle full autonomy',
  'cmd.model': 'Switch the model',
  'cmd.work-items': 'Manage work items (list/add/move/show)',
  'cmd.sprints': 'Manage sprints + burndown',
  'cmd.plans': 'Browse, resume or diff plans',
  'cmd.verify': 'Run the verification mesh on a task',
  'cmd.review': 'Review the working tree or a task',
  'cmd.mission': 'Run a long autonomous mission',
  'cmd.orchestrate': 'Run an authored orchestration spec',
  'cmd.schedule': 'Manage scheduled autonomous jobs',
  'cmd.scope': 'Map the scope of a task (read-only)',
  'cmd.status': 'Show project + run status',
  'cmd.stats': 'Show usage statistics',
  'cmd.logs': 'Show logs for a task',
  'cmd.insights': 'Show insights across tasks',
  'cmd.agents': 'List or inspect custom agents',
  'cmd.skills': 'List available skills',
  'cmd.session': 'Export, import or list sessions',
  ...
  'repl.help-manage':
    '  /work-items /sprints /plans /verify /review /mission /orchestrate /schedule /scope /status /stats /logs /insights /agents /skills /session — same as the `excalibur <command>`s',
  ...
  'context.safetyAuto':
    'Auto-accept on — edits & commands apply without asking (blocked paths stay protected).',
  ...
  'agent-turn.gerund-default': 'Working on your task…',
  ...
  'event.run-started': '▶ task started',
  ...
  'event.run-completed': '■ task {status}',
  'event.unknown': '  {type}',
