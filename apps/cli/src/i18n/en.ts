...
export const EN: Catalog = {
  ...
  "work-items.comment-empty": "Provide a comment body: excalibur work-items comment <number> <text>",
  ...
  "plans.none": "No saved plans yet. Approve a plan in plan mode and it's saved to .excalibur/plans/.",
  ...
  "run-pipeline.estimateOverBudget": "Heads up: the estimate {cost} exceeds your --budget {budget} — the run will stop at the cap.",
  ...
  "agent-turn.allow_action": "  Allow this action?  (y = yes · n = no · a = Auto mode, stop asking)",
  ...
  "repl.swarm-usage": "Usage: /swarm <task> — fans the task out to real parallel agents (independent subtasks, live lanes).",
  ...
  "repl.help-swarm": "  /swarm <task>  fan out to real parallel agents (independent subtasks, live lanes)",
