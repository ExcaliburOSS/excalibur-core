...
export const ES: Catalog = {
  ...
  'plans.diff_need_two': 'Hacen falta al menos dos planes guardados para comparar.',
  'plans.diff_missing': 'No pude leer uno de esos planes.',
  'plans.diff_heading': 'Diff de plan · {from} → {to}',
  'plans.diff_phases': 'Fases: {changes}',
  'sprints.none': 'Aún no hay sprints. Crea uno con `excalibur sprints create`.',
  'sprints.status.planned': 'Planificado',
  'sprints.status.active': 'Activo',
  'sprints.status.completed': 'Completado',
  'sprints.col_id': 'Sprint',
  'sprints.col_name': 'Nombre',
  'sprints.col_status': 'Estado',
  'sprints.col_window': 'Ventana',
  'sprints.col_items': 'Ítems',
  'sprints.col_points': 'Puntos',
  'sprints.needs_name': 'Un sprint necesita un nombre.',
  'sprints.bad_date': '{label} debe ser una fecha YYYY-MM-DD (recibido "{value}").',
  'sprints.not_found': 'No existe el sprint "{id}".',
  'sprints.created': 'Creado {id} · {name}.',
  'sprints.started': 'El sprint {id} está activo.',
  'sprints.completed': 'Sprint {id} completado.',
  'sprints.assigned': 'Asignados {count} ítem(s) a {id}.',
  'sprints.assign_failed': 'No se pudo asignar {key}.',
  'sprints.points_summary': '{done}/{total} puntos hechos · {items} ítems',
  'sprints.burndown': 'Burndown (puntos restantes):',
  'sprints.remaining': '{n} restantes',
  'sprints.no_items': 'Aún no hay ítems en este sprint. Asigna con `sprints assign`.',
  ...
  'run-pipeline.runDir': 'Tarea {id} → {dir}',
  'run-pipeline.runCompleted': 'Tarea {id} completada.',
  'run-pipeline.runFinishedStatus': 'La tarea {id} finalizó con estado: {status}',
  ...
  'event.run-started': '▶ tarea iniciada',
  ...
  'event.run-completed': '■ tarea {status}',
  'event.unknown': '  {type}',
